...
export class App {
  ...
  protected readonly cities = signal<City[]>([
    { name: 'Brussels', eventCount: 47, icon: '🏛️' },
    { name: 'Antwerp', eventCount: 35, icon: '💎' },
    { name: 'Ghent', eventCount: 28, icon: '🏰' },
    { name: 'Bruges', eventCount: 22, icon: '🌉' },
    { name: 'Leuven', eventCount: 19, icon: '📚' },
    { name: 'Liège', eventCount: 16, icon: '🔥' }
  ]);
  ...
  protected readonly categories = signal<Category[]>([
    { id: 'all', name: 'All', icon: '✨', color: '#7B68C8' },
    { id: 'music', name: 'Music', icon: '🎵', color: '#FF6B5B' },
    { id: 'food', name: 'Food', icon: '🍔', color: '#FFD93D' },
    { id: 'culture', name: 'Culture', icon: '🎭', color: '#9B7EDE' },
    { id: 'sports', name: 'Sports', icon: '⚽', color: '#6BCAB3' },
    { id: 'art', name: 'Art', icon: '🎨', color: '#FFB5C5' }
  ]);
